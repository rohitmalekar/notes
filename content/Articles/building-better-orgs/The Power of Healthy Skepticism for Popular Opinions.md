---
title: The Power of Healthy Skepticism for Popular Opinions
tags:
  - Well-Being
type:
  - Article
...
_Opinion: "Investing for impact implies sacrifice in financial returns for a VC."_  
  
8 years into [Kapor Capital's](https://www.kaporcapital.com/) “impact only” experiment, their portfolio ranked in the top quartile of funds of comparable size. This is not news. This was proven in 2019. Since 2011, they have invested exclusively in startups that are in turn committed to "closing the gaps of access, opportunity, and outcomes for low-income communities and communities of color in the US". You can read the entire report [here](https://impact.kaporcapital.com/).

  
_Opinion: "Start-up journey is a J-curve growth pumped by venture funds raised at incremental milestones."_  
  

[Zebras Unite.Org](https://www.zebrasunite.org/) is redefining ownership models, creating alternative capital taxonomy, and much more for a holistic and inclusive ecosystem for start-ups. Specifically, in collaboration with [Media Enterprise Design Lab](https://www.colorado.edu/lab/medlab/about), their approach to exploring if startups could [“exit to community”](https://www.colorado.edu/lab/medlab/exit-to-community) transitioning ownership to the people who built and use it is fascinating. 

  
_Opinion: "An exit at higher valuation automatically implies greater earnings for the founder"_  
  
This is an example from ["Meaningful Exits for Founders"](https://bryce.vc/post/154821809555/meaningful-exits-for-founders) by [Bryce Roberts](https://bryce.vc/), who founded one of the first-ever institutional seed funds.
...
_Opinion: "Building a start-up off of a platform you don't own will limit your growth"  
