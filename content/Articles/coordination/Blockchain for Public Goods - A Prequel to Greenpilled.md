---
title: Blockchain for Public Goods - A Prequel to Greenpilled
tags:
  - Web3
type:
  - Article
permalink: blockchain-public-goods
date: 2022-03-01
...
[[Blockchain for Public Goods - A Prequel to Greenpilled#What is broken|What is broken?]]
[[Blockchain for Public Goods - A Prequel to Greenpilled#Why the current systems aren't enough|Why the current systems aren't enough?]]
[[Blockchain for Public Goods - A Prequel to Greenpilled#What can lead to an equitable future|What can lead to an equitable future?]]
[[Blockchain for Public Goods - A Prequel to Greenpilled#How can crypto fix any of this|How can crypto fix any of this?]]
[[Blockchain for Public Goods - A Prequel to Greenpilled#What will it take|What will it take?]]
[[Blockchain for Public Goods - A Prequel to Greenpilled#About Greenpilled|About Greenpilled]]
...
- Our public health system and primary care infrastructure in the rural areas is being intentionally dismantled at the behest of lobbying from the private sector. My interview notes from last year with [Dr. Sylvia Karpagam](https://twitter.com/sakie339) on this topic in context of COVID-19 are [here](https://twitter.com/RohitMalekar/status/1405948143552778240?s=20&t=61yLb4vuyiNseJcL5A1ZRA).
...
- Our artisan economy supports 200 million people (see the report, [Business of Handmade](https://www.businessofhandmade.com/), by [200 Million Artisans](https://200millionartisans.org/)). It is, however, one of the most neglected sectors even though it plays such a crucial role in local culture, employment, sustainability, heritage preservation, let alone the role the craft plays as a [central piece of democracy](https://twitter.com/RohitMalekar/status/1455255403286044673?s=20&t=61yLb4vuyiNseJcL5A1ZRA), as articulated by [Nathan Schneider](https://twitter.com/ntnsndr).
...
> **Inherent design flaws incentivize individual success at the [[Individual Rationality|expense of community harm]].**
...
In game theory, Schelling point is a solution that people tend to choose by default in the absence of communication. The concept was introduced by the American economist Thomas Schelling in his book _The Strategy of Conflict_. 
...
> **"There is no reason to believe that bureaucrats and politicians, no matter how well meaning, are better at solving problems than the [[People on the Spot|people on the spot]], who have the strongest incentive to get the solution right."** 
> 
> **- Elinor Ostrom**
...
In other words, Web3 allows the ability to program our values into our money. Blockchain can codify incentive design that encourages action towards socially beneficial outcomes at scale. These incentives drive collective action to overcome common failures of coordination. The atomic unit of this transformation is an [Impact DAO](https://gov.gitcoin.co/t/a-vision-for-a-pluralistic-civilizational-scale-infrastructure-for-funding-public-goods/9503) - a collective action that has a net positive impact on building and sustaining public goods. Related Impact DAOs stack over each other to replace existing centers of power and build transparent systems of tomorrow.
...
At a minimum, an Impact DAO will need to crack the [[DAO Trifecta|trifecta]] of:
...
### About Greenpilled
Authored by [Kevin Owocki](https://owocki.com/), this book is about cryptoeconomic systems that create positive externalities for their neighbors and for the world.  
...
**What's after Greenpilled?** IMPACTDAOs - A soon-to-be-released book that captures the empirical knowledge on how crypto is regenerating the world, a [map of Impact DAOs](https://twitter.com/owocki/status/1504875382893338625?s=20&t=l7IRf6oq8Vna-YyrNXIkkg) that complements the theory in Greenpilled. 
