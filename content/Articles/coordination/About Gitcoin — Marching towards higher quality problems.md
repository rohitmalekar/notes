...
---
# About Gitcoin — Marching towards higher quality problems
...
Possibly for the first time in the history of humankind, a group of individuals with a shared interest have the collective power to transparently institutionalize and autonomously operate a mission irrespective of where they pay their taxes or what they do for a living. The theoretical potential of Web3, however, hinges on having interoperable digital rails and the lego blocks to facilitate this transformation in ways that are resilient and sustainable. In this article, we will review the [Gitcoin](https://gitcoin.co/) community’s role in persistently pushing for progress to solve high quality problems to enable this transformation.
...
> **_With the current systems, we keep losing the game over and over again._**
...
> _“With programable money, we can program our values into our money” (_[_Greenpilled_](https://store.gitcoin.co/products/green-pill-book-digital-edition)_)._

Web3 allows the ability to program our values into our money. Blockchain can codify incentive design that encourages action towards socially beneficial outcomes at scale. These incentives drive collective action to overcome common failures of coordination. The atomic unit of this transformation is an [Impact DAO](https://store.gitcoin.co/products/impactdao-book-digital-edition) — a collective action that has a net positive impact on building and sustaining public goods. Related Impact DAOs stack over each other to replace existing centers of power and build transparent systems of tomorrow.
...
1.  [**Bounties**](https://gitcoin.co/bounties/funder) **and** [**hackathons**](https://gitcoin.co/hackathons) **— Building with and for the community**  
...
2.  [**Grants**](https://gitcoin.co/grants/) **— Community-driven funding coordination**  
...
3.  [**Grants Protocol**](https://gitcoin.co/protocol) **and** [**Gitcoin Passport**](https://passport.gitcoin.co/) **— From products to protocols**  
...
Since May 2021, the platform is governed by Gitcoin DAO — you can learn more about it [here](https://gitcoindao.com/).