---
title: GG24 Sensemaking - Open Data Standards, Infrastructure & Analytics for Ethereum
tags:
  - Web3
  - Decentralization
type:
  - Portfolio
permalink: gg24_sensemaking
...
This report is part of [Gitcoin Grants 24’s Strategic Sensemaking Framework](https://gov.gitcoin.co/t/gitcoin-grants-24-strategic-sense-making-framework/20865), an initiative designed to identify Ethereum’s most meaningful, urgent, and solvable problems through structured community research.
...
1. **Unified L1-L2 Data Visibility:** Ethereum’s growth now spans dozens of active Layer-2 networks, each generating its own transaction, liquidity, and governance data. Without aggregation, this activity remains siloed, making it hard to see the ecosystem as a whole. The demand for cross-network standards (e.g., [ERC-7683](https://eips.ethereum.org/EIPS/eip-7683) for unified cross-L2 transactions) signals a [clear need](https://www.coindesk.com/opinion/2025/02/06/how-to-fix-ethereum-s-fragmentation-problem) for integration not just at the transaction layer, but at the information layer. Open data infrastructure that unifies L1 and L2 metrics would let the community, builders, and external observers track adoption, usage, and health across the entire Ethereum stack. Even if liquidity remains fragmented, information should not.

2. **Institutional DeFi and Legitimacy:** Billions of dollars of [patient capital](https://www.sec.gov/newsroom/speeches-statements/corpfin-certain-liquid-staking-activities-080525) could flow into the ecosystem if we demonstrate robust risk analytics, real-time monitoring, and trustworthy data onchain. Providing [rich, open data](https://dune.com/blog/bridging-the-gap-how-blockchain-analytics-empowers-traditional-investors) (on trading volumes, liquidity, collateralization, DAO treasury holdings, etc.) can give institutions and regulators confidence. By funding open analytics and data infrastructure now, Ethereum positions itself as the most transparent and analyzable financial system in the world, attracting institutional adoption while staying true to decentralization.

3. **Transparent and Effective OSS Funding:** The coming years present an opportunity to scale capital allocation experiments into a core strength of Ethereum’s ecosystem. Importantly, such funding [needs robust data to be effective](https://ethresear.ch/t/a-roadmap-for-funding-ethereum-s-open-source-infrastructure/22278#p-54175-phase-2-an-ecosystem-wide-open-source-funding-dashboard-5): we need to measure impact, track contributions, and hold recipients accountable in the open. In essence, open data enables evidence-based governance. It replaces guesswork or politics with objective metrics, leading to smarter grant allocations, protocol upgrades guided by real usage patterns, and DAO votes aligned with onchain reality. The result is a more adaptive and efficient ecosystem, allocating resources where they have the highest impact.
...
![[atlas.jpeg]]The above taxonomy organizes existing and potential tools into six verticals, each mapped to the primary opportunity it most impacts. This serves as a blueprint for targeted funding closing the most critical coordination gaps and aligning Ethereum’s data infrastructure with its strategic future.
...
For instance, multiple chains (e.g., Polkadot and Cosmos) are funding public dashboards to monitor cross-chain health. Notably, Polkadot [allocated over $1 million](https://www.opengov.watch/reports/treasury-reports/05-2024-treasury-report-q4#:~:text=Operations%20%286,166k%20USD) from its treasury in 2024 to fund explorers and indexing tools. Cosmos’s [“Map of Zones”](https://blog.cosmos.network/visualize-the-interchain-map-of-zones-8acc8c5f93d8) dashboard visualizes cross-chain activity across 100+ chains. We also compared how open tools (Dune, Blockscout) perform versus closed systems in accessibility, redundancy, and community trust.
...
Sources included Open Source Observer adoption data, DeepDAO’s treasury monitors, Gitcoin grant rounds, and dashboards from Dune, L2Beat, and Blockscout. Key thought leadership came from Vitalik’s essays on [credible neutrality](https://balajis.com/p/credible-neutrality), [alignment](https://vitalik.eth.limo/general/2024/09/28/alignment.html), [the “Scourge” roadmap phase](https://ethroadmap.com/scourge.html), and Kevin Owocki’s reflections on [meaning awareness](https://research.allo.capital/t/meaning-awareness-we-need-new-ways-to-find-what-actually-matters/379). Community threads on ETHResearch, Optimism forums, and Arbitrum DAO provided qualitative insight into what developers and funders actually use.

Data triangulation revealed Gitcoin as a unique validator of demand. Tools like Open Source Observer and Blockscout were not only widely adopted, but also consistently funded through matching pools. Notably, 8 of the top 30 projects selected in GG23 Mature Builders Retro Funding round based on data-driven, metrics-based rankings aligned with use cases identified in the taxonomy and collectively received a [third of the retro funding pool](https://gov.gitcoin.co/t/gg23-oss-program-mature-builders-retro-funding-results/20365) from badgeholders.

![[fund_share.jpeg]]In short, both qualitative (forum debates, grantee feedback) and quantitative (donation totals, usage stats) signals converged to identify a high-leverage opportunity: fund a domain that can unify fractured data efforts and give the ecosystem shared visibility across layers, governance, and funding. Without this, Ethereum risks data opacity at a time when trust, accountability, and interoperability matter more than ever.
...
Gitcoin is uniquely positioned to address this challenge as a decentralized, community-aligned platform purpose-built to fund digital public goods. Traditional institutions hesitate to fund tools that don't offer direct returns. Gitcoin’s strength lies in convening fragmented stakeholders across developers, donors, L2 teams, and researchers around a shared vision for open tooling. Gitcoin’s networked model where users, DAOs, and sponsors collectively fund what they value has already supported domain-aligned projects like [Beaconcha.in](http://beaconcha.in/), Blockscout, BrightID, DAOStar, DAppNode, EAS, Human Passport (previously Gitcoin Passport), L2Beat, and OSO.
...
1. **Tangible Deliverables:** High-performing established projects release updates, dashboards, or APIs improving data accessibility and reliability.
2. **New Tools Emerge:** As an example, the grant leads to the development of an “Ethereum Data Commons” or a multi-chain explorer with real-time insights across L2s.
3. **User Adoption & Community Growth:** Tools and libraries see usage spikes.
...
This model blends verifiable metrics with expert judgment to avoid [“manufactured significance”](https://research.allo.capital/t/meaning-awareness-we-need-new-ways-to-find-what-actually-matters/379) and ensure funding decisions reflect genuine, lasting impact measured by whether open data tools shape governance, inform funding, and boost user trust.